...
Text data pre-processing, or normalization, is the process of converting text data into a more machine-readable form before analyzing it. This normalization entails a number of processes, which can include tokenization, stop words removal, and morphological normalization, most commonly in the form of stemming and lemmatization. 
