...
And here's a step-by-step breakdown of separating the bigrams into unigrams, filtering out stop words, and finally uniting the bigrams back together in the dataframe bigrams_united.
...
a <- length(bigrams_united$chapter)/4
b <- a*2
c <- a*3
bigrams_united$chapter[1:a] <- 1
bigrams_united$chapter[(a+1):b] <- 2
bigrams_united$chapter[(b+1):c] <- 3
bigrams_united$chapter[(c+1):length(bigrams_united$chapter)] <- 4
...
## Example 1: Tokenize and Remove Stop Words for Jane Austin
Corydon
