...
As you can see, handling text data with tidytext is very simple. The big advantage of using this package is that it works with other tidyverse functions, and this frame work can even be used for some analytic tasks such as sentiment analysis and topic modeling. 