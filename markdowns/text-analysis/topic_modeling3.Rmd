...
1. Ball ball ball planet vote
2. Vote planet planet vote vote 
3. Planet planet star planet ball
4. Planet star vote planet ball
...
So for example, the first sentence is mostly made up of the word ball, so we will place that into the sports category. The second sentence is mostly made up of the word vote, so we will place it in the politics topic, though only barely because it has the word planet twice as well. The last two are mostly related to science, so we put those in the science topic. 
...
The orange ball represents the "Sports" topic, so we put it close to the "Ball" corner. The red ball represents "Politics", so we put it  close to the vote corner. The blue ball represents "science", so we put it between the star and planet corners. 
